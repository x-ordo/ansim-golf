...
const MobileNav: React.FC = () => {
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md border-t border-slate-200 z-50 px-6 py-3 pb-safe">
      <div className="flex justify-between items-center max-w-lg mx-auto">
        ...
        <button className="flex flex-col items-center gap-1 text-slate-400">
          ...
          <span className="text-[10px] font-medium">부킹</span>
        </button>
        <button className="flex flex-col items-center gap-1 text-slate-400">
          ...
          <span className="text-[10px] font-medium">투어</span>
        </button>
        <button className="flex flex-col items-center gap-1 text-slate-400">
