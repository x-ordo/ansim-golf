...
export const MOCK_TEE_TIMES: TeeTime[] = [
  ...
  },
  {
    ...
    course: {
      ...
      location: '경기 파주',
      region: 'SUDOKWON_NORTH',
      image: 'https://images.unsplash.com/photo-1587174486073-ae5e5cff23aa?q=80&w=1600&auto=format&fit=crop',
      distanceKm: 36,
    },
    date: '2026-01-07',
    time: '11:23',
    ...
    manager: {
      ...
      isVerified: false,
      partnerType: 'GENERAL',
      stats: { totalBookings: 450, favoriteCount: 32 }
    },
    description: '서원힐스 11:23 무관 2명 조인 구합니다.',
    escrowEnabled: true,
    refundPolicy: '공정위 표준약관 준수',
    joinRequirements: { gender: 'ANY', count: 2 }
  },
  {
    id: 't5',
    course: {
    ...
    manager: {
      ...
      isVerified: true,
      partnerType: 'CERTIFIED',
      stats: { totalBookings: 1200, favoriteCount: 145 }
    },
    description: '부부·커플(2) 조인 구합니다. 매너 플레이 환영!',
    escrowEnabled: true,
    refundPolicy: '임박취소 불가',
    joinRequirements: { gender: 'COUPLE', count: 2 }
  },
  {
    id: 't6',
    course: {
    ...
    manager: {
      ...
      isVerified: true,
      partnerType: 'PREMIUM',
      stats: { totalBookings: 2100, favoriteCount: 180 }
    },
    description: '[강원] 1/1~1/31 울산바위 맛집! 36홀+리조트 숙박 패키지.',
    escrowEnabled: true,
    refundPolicy: '투어 특별약관 적용',
    isTourPackage: true,
    lodgingInfo: '델피노 리조트 1박'
  },
  {
    id: 't7',
    course: {
    ...
    manager: {
      ...
      isVerified: true,
      partnerType: 'CERTIFIED',
      stats: { totalBookings: 3200, favoriteCount: 95 }
    },
    description: '긴급! 클럽72 오션 무관 2명 바로 조인 가능.',
    escrowEnabled: true,
    refundPolicy: '공정위 표준약관 준수',
    joinRequirements: { gender: 'ANY', count: 2 }
  }
